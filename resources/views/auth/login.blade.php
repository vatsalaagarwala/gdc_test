                ...
                <div class="row">
                    <div class="col-12 col-md-8 offset-md-2 mt-4">
                        <h1 class="mb-4" >Log In </h1>
                            <div class="signup-form">
                                {!! Form::open(array('url' => 'login','class'=>'','id'=>'signup','role'=>'form')) !!} 
                                    ...
                                    <form class="form-validate">
                                        ...
                                        <hr class="my-4">
                                        <p class="text-sm text-muted">By signing up you agree to <a href="#">Terms and Conditions</a> and <a href="#">Privacy Policy</a>.</p>
                                    </form>
                            ...
                            <a href="/idishum-signup"> <button type="" class="btn btn-sm btn-block btn-info">Sign Up </button></a>
                    </div>
                </div>
