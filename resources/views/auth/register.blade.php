            ...
            <div class="col-12 col-md-8 col-lg-8">
                <div class="row">
                    <div class="col-12 col-md-8 offset-md-2 mt-4">
                        <h1 class="mb-4" >Author Sign Up </h1>
                            <div class="signup-form">
                                {!! Form::open(array('url' => 'register','class'=>'','id'=>'signup','role'=>'form')) !!} 
                                    ...
                                    <form class="form-validate">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="name" id="name" type="text" placeholder="Name" autocomplete="off" required data-msg="Please enter your name" class="form-control">
                                            </div>
