...
<section>
    <div class="container">
                ...
                <div class="article_subtitle">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 ">
                            <div class="article_subtitle">
                                <h5 style=" display : inline;">2 min read | </h5>
                                <i class="far fa-eye"></i><h5 style="display: inline;"> 248</h5>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row mb-5">
            <div class="col-xs-12 col-md-10 col-lg-10 offset-md-1 offset-lg-1">
