            ...
            <div class="col-xs-12 col-md-9 col-lg-9">
                <div class="row">
                    <div class="col-12 mt-4 mb-4 d-flex justify-content-center">
                        <h1 class="text-dark">Articles Category</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="gymlisting p-2">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary btn-sm">Feature</button>
                                        <button type="button" class="btn btn-warning btn-sm">Editor's Pick</button>
                                    </td>
                                    </tr>
                                    <tr>
                                    <th scope="row">2</th>
                                    ...
                                    <td><span class="badge badge-warning">Editor's Pick</span></td>
                                    <td>
                                        <button type="button" class="btn btn-primary btn-sm">Feature</button>
                                        <button type="button" class="btn btn-warning btn-sm">Editor's Pick</button>
                                    </td>
