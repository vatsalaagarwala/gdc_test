    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1> Halitosis : </h1>
          <p style="color: white">Halitosis or bad breath is a common dental problem that can have a number of potential causes. It is the third most common reason that people seek dental care. Simple home remedies and lifestyle changes can often remove the issue. However, visit to the dentist is recommended.
            <br>
            Treatments : 
            ...
            <a href="/testuri?test=Scaling and Polishing&slug=Oral hygiene is the practice of keeping one's mouth clean and free of disease and other problems (e.g. bad breath) by regular brushing of the teeth (dental hygiene) and cleaning between the teeth" target="_blank">Oral Hygiene</a>
