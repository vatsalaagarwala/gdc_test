    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1> Pulpitis : </h1>
          <p style="color: white">Pulpitis occurs when the inner pulp portion of the tooth, which is made up of blood vessels and nerves, becomes inflamed. Irreversible pulpitis occurs when inflammation and other symptoms, such as pain, are severe, and the pulp cannot be saved.
            <br>
            Treatments : 
            <a href="/testuri?key=rct" target="_blank">RCT(Root Canal Treatment)</a>
            <a href="/testuri?key=filling" target="_blank">Filling</a>
            <a href="/testuri?key=crown" target="_blank">Crown</a>
          </p>
        </div>
      </div>
    </div>
