    ...
    <div class="row">
      <div class="col-md-8">
        <ol class="breadcrumb">
          ...
          <li class="active">List For Free</li>
        </ol>
      </div>
    </div>
  </div>
      ...
      <div class="tab-content ">
        ...
        @endif
            ...
            <div class="form-group">
              <label class="control-label" for="first_name">Doctor's Name<span class="required">*</span></label>
              <input id="first_name" name="first_name" type="text" value="" placeholder="Enter Doctor's Name" class="form-control input-md">
            </div>

            <div class="form-group">
              <label class="control-label" for="first_name">Clinic Name<span class="required">*</span></label>
              <input id="clinic_name" name="clinic_name" type="text" value="" placeholder="Enter Clinic Name" class="form-control input-md">
            </div>

            <div class="form-group">
              <label class="control-label" for="first_name">Location<span class="required">*</span></label>
              <input id="location" name="location" type="text" value="" placeholder="Enter Your Location (Indian Cities)" class="form-control input-md">
            </div>
            ...
            <div class="form-group">
              ...
              <input id="contact" name="contact" type="number" placeholder="Enter Phone Number (Indian Phone Number)" value="" class="form-control input-md">
            </div>
            ...
            <div class="form-group">
              ...
              <input id="password" name="password" type="text" value="" placeholder="Enter Password" class="form-control input-md">
            </div>

            <div class="form-group">
              <label class="control-label" for="password">DCI Registration Number<span class="required">*</span></label>
              <input id="password" name="dci" type="text" value="" placeholder="Enter DCI Registration Number" class="form-control input-md">
            </div>
