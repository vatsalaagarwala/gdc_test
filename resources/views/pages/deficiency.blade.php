    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1> Deficiency : </h1>
          <p style="color: white">A nutritional deficiency occurs when the body doesn't absorb or get from food the necessary amount of a nutrient. Deficiencies can lead to a variety of health problems including dental problems.
            <br>
            Treatments : 
            <a href="/testuri?test=Nutritional Supplements&slug=A dietary supplement is a manufactured product intended to supplement the diet when taken by mouth as a pill, capsule, tablet, or liquid." target="_blank">Nutritional Supplements</a>
          </p>
        </div>
      </div>
    </div>
