    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1> Malignancy : </h1>
          <p style="color: white">Malignancy or  Oral cancer appears as a growth or sore in the mouth that does not go away. Oral cancer, which includes cancers of the lips, tongue, cheeks, floor of the mouth, hard and soft palate, sinuses, and pharynx (throat), can be life threatening if not diagnosed and treated early.
            <br>
            Treatments : 
            <a href="/testuri?test=Medication&slug=A medication is a drug used to diagnose, cure, treat, or prevent disease. Drug therapy is an important part of the medical field." target="_blank">Medication</a>,
