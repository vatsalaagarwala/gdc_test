    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1> Pulp necrosis : </h1>
          <p style="color: white">Pulp necrosis refers to a condition where the pulp inside your teeth dies. This is often the last stage of chronic pulpitis. When you have dental (oral) diseases, the pulp can be affected and eventually die off. This can lead to other oral health issues if not treated promptly.
            <br>
            Treatments : 
