    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1> Periodontitis : </h1>
          <p style="color: white">Periodontitis is a serious gum infection that damages the soft tissue and destroys the bone that supports your teeth. Periodontitis can cause teeth to loosen or lead to tooth loss.
            <br>
            Treatments : 
