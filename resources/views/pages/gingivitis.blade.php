    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1> Gingivitis : </h1>
          <p style="color: white">Gingivitis is an infection of the gums. Symptoms are acute pain, bleeding, and/or foul breath. Risk factors are poor oral hygiene, nutritional deficiencies, immunodeficiency and sleep deprivation.
            <br>
            Treatments : 
