...
<div class="main-container">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <div class="well-box">
        {!! Form::open(array('url' => 'support-message','class'=>'','id'=>'signup','role'=>'form')) !!}
        ...
        <div class="well-box">
          <ul class="listnone"> --}}
            {{-- <li class="address">
              ...
              <p>Chinmoy Hazarika, Urmi Nagar. House No. 39 <br>
                Guwahati
                  </p>
            ...
            {{-- <li class="email">
              ...
              <a href="mailto:cgentledental@gmail.com">cgentledental@gmail.com</a>
              <p>{{getcong('contact_email')}}</p>
            </li> --}}
            {{-- <li class="call">
              <h2><i class="fa fa-phone"></i>Contact</h2>
              <p><a tel="‭+91 78966 46246‬">+91 78966 46246‬</a></p>
