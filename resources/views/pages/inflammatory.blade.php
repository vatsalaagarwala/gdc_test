    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1> •  Inflammatory/ Non-Inflammatory Gingival Enlargement : </h1>
          <p style="color: white">Gingival enlargement is an increase in the size of the gingiva (gums). It is a common feature of gingival disease. Gingival enlargement can be caused by a number of factors, including inflammatory conditions and the side effects of certain medications.
