...
@section('head_title', $sub_cat->sub_category_name.' | '.getcong('site_name') )
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1>{{$sub_cat->sub_category_name}} Listings</h1>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-md-8">
        <ol class="breadcrumb">
          ...
          <li class="active">{{$sub_cat->sub_category_name}} Listings</li>
        </ol>
      </div>
    </div>
  </div>
