    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1> Cavity : </h1>
          <p style="color: white">Tooth decay, also known as dental caries or cavities, is a breakdown of teeth due to acids made by bacteria. The cavities may be a number of different colors from yellow to black. Symptoms may include pain and difficulty with eating.
            <br>
            Treatments : 
