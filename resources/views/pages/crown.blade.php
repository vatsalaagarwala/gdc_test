    ...
    <div class="row">
      <div class="col-md-12">
        <div class="page-header">
          <h1> Crowns : </h1>
          <p style="color: white">A dental crown is a tooth-shaped "cap" that is placed over a tooth -- to cover the tooth to restore its shape and size, strength, and improve its appearance.
          The crowns, when cemented into place, fully encase the entire visible portion of a tooth that lies at and above the gum line.

          <br>
            Conditions treated by Crowns : 
            <a href="/testuri?test=Cavity&slug=A dental crown is a tooth-shaped cap that is placed over a tooth -- to cover the tooth to restore its shape and size, strength, and improve its appearance. The crowns, when cemented into place, fully encase the entire visible portion of a tooth that lies at and above the gum line." target="_blank">Cavity</a>,
            <a href="/testuri?key=cracked" target="_blank">Cracked</a>,
            <a href="/testuri?key=rct" target="_blank">Root Canal Treatment</a>
