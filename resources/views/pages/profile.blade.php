          ...
          <div class="col-md-12" id="aboutus">
            ...
            <div class="well-box">
              ...
              {!! Form::open(array('url' => 'profile','class'=>'','id'=>'myProfile','role'=>'form','enctype' => 'multipart/form-data')) !!} 
                <div class="form-group col-md-6">
                  <label for="first_name" class="control-label">Name <span class="required">*</span></label>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" required class="form-control input-md" placeholder="Email" name="email" id="email" value="{{$user->email}}">
                </div>
                <div class="form-group col-md-6">
                  <label for="mobile" class="control-label">Phone <span class="required">*</span> </label>
                  <input type="text" required class="form-control input-md" placeholder="+01 123 456 78" name="mobile" id="mobile" value="{{$user->mobile}}">
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="well-box">
              ...
              <div class="form-horizontal">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label">Quora Url:-</label>
                  <div class="col-sm-9">
