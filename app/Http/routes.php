...
Route::get('support', 'IndexController@our_support');
Route::post('support-message', 'IndexController@support_message');
...
Route::post('registerpatients', 'IndexController@postRegisterpatients');
...
Route::post("lead_capture", "IndexController@lead_capture");
